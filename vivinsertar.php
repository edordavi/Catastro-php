...
$nombre_z=  utf8_decode($_GET["nombre_z"]);

$conexion = new mysqli("localhost","eavila","emildaniel","catastro");

$consulta=$conexion->prepare("INSERT INTO VIVIENDA VALUES(?,?,?,?,?,?,?)");

$consulta->bind_param("sisiiss", $calle,$numero,$tipo_v,$codigo_p,$metros,$od_v,$nombre_z);
